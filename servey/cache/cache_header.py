...
from servey.util import filter_none, secure_hash
...
class CacheHeader:
    ...
    def get_cache_control_str(self):
        ...
        if self.etag is not None:
            return 'no-cache'  # object must be re-validated before each reuse.
        else:
            return 'no-store'  # object should not be cached
