...
for _action, _ in get_default_action_context().get_actions_with_trigger_type(FixedRateTrigger):
...
def setup_periodic_tasks(sender, **kwargs):
    for action, trigger in get_default_action_context().get_actions_with_trigger_type(FixedRateTrigger):
