...
from servey2.servey_aws.event_parser.factory.event_parser_factory_abc import create_parser_factories, \
    EventParserFactoryABC
from servey2.servey_aws.lambda_handler import LambdaHandler
from servey2.servey_aws.result_render.factory.result_render_factory_abc import ResultRenderFactoryABC, \
...
class LambdaHandlerFactory:
    parser_factories: Tuple[EventParserFactoryABC, ...] = field(default_factory=create_parser_factories)
    render_factories: Tuple[ResultRenderFactoryABC, ...] = field(default_factory=create_render_factories)
