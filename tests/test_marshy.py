...
from marshy_config_servey import configure_starlette, configure_strawberry, configure_strawberry_starlette, \
    configure_aws, configure_serverless, configure_celery, configure_jinja2, configure_web_page_action_endpoint_factory, \
    configure_web_page_event_handler, configure_web_page_trigger_handler
